...
export default function Products() {
  return (
    <section id="produtos" className="py-20 lg:py-28 bg-secondary/50 relative overflow-hidden">
      {/* Background elements */}
      <div className="absolute -top-20 left-1/4 w-96 h-96 bg-gradient-gold/5 rounded-full blur-3xl" />
      <div className="absolute -bottom-20 right-1/4 w-80 h-80 bg-orange/5 rounded-full blur-3xl" />
      
      {/* Floating decorative elements */}
      <div className="absolute top-32 right-20 w-6 h-6 opacity-10">
      ...
      <div className="absolute bottom-32 left-20 w-10 h-10 opacity-10">
        <svg viewBox="0 0 100 80" fill="currentColor" className="text-primary">
          <path d="M50 0L65 30L100 40L75 60L80 100H20L25 60L0 40L35 30L50 0Z" />
        </svg>
      </div>
