      ...
      <div className="section-container relative z-10 px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5 md:gap-6 mb-8 sm:mb-10 md:mb-12">
          {products.map((product) => (
            <div
              key={product.name}
              className="group relative rounded-xl sm:rounded-2xl overflow-hidden bg-card border border-border shadow-card transition-all duration-300 hover:shadow-xl hover:border-primary/30"
            >
              {/* Image */}
