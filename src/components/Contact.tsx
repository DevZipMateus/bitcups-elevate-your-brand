...
export default function Contact() {
  return (
    <section id="contato" className="py-20 lg:py-28 bg-background relative overflow-hidden">
      {/* Background elements */}
      <div className="absolute top-10 right-10 w-72 h-72 bg-gradient-gold/5 rounded-full blur-3xl" />
      <div className="absolute bottom-10 left-10 w-56 h-56 bg-orange/5 rounded-full blur-3xl" />
      
      {/* Floating crown elements */}
      <div className="absolute top-20 left-1/4 w-8 h-8 opacity-5">
      ...
      <div className="absolute bottom-20 right-1/3 w-6 h-6 opacity-5">
        <svg viewBox="0 0 100 80" fill="currentColor" className="text-primary">
          <path d="M50 0L65 30L100 40L75 60L80 100H20L25 60L0 40L35 30L50 0Z" />
        </svg>
      </div>
      ...
      <div className="section-container relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          {/* Map */}
          <div className="h-[400px] lg:h-full min-h-[400px] rounded-2xl overflow-hidden border border-border shadow-card">
            <iframe
