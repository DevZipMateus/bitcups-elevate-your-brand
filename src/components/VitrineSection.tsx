  ...
  return (
    <section className="relative py-20 overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gold-light rounded-full blur-3xl opacity-30" />
      </div>

      {/* Floating icons */}
      <div className="absolute top-20 right-20 text-gold/30 animate-float">
        <Crown className="w-16 h-16" />
      </div>
      <div className="absolute bottom-20 left-20 text-orange/30 animate-float" style={{ animationDelay: '1s' }}>
      ...
      <div className="section-container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gold/20 rounded-full text-primary text-sm font-medium mb-6 animate-fade-up">
            <Sparkles className="w-4 h-4 text-gold" />
            <span>Catálogo Online</span>
          </div>

          {/* Main heading */}
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-primary mb-6 animate-fade-up" style={{ animationDelay: '0.1s' }}>
            Explore Nossa{' '}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10 animate-fade-up" style={{ animationDelay: '0.3s' }}>
            <div className="bg-primary/5 backdrop-blur-sm rounded-xl p-6 border border-primary/10">
              ...
              <h3 className="text-primary font-semibold mb-2">+500 Produtos</h3>
              <p className="text-muted-foreground text-sm">Grande variedade para todos os gostos</p>
            </div>
            <div className="bg-primary/5 backdrop-blur-sm rounded-xl p-6 border border-primary/10">
              ...
              <h3 className="text-primary font-semibold mb-2">Qualidade Premium</h3>
              <p className="text-muted-foreground text-sm">Materiais selecionados com cuidado</p>
            </div>
            <div className="bg-primary/5 backdrop-blur-sm rounded-xl p-6 border border-primary/10">
              <div className="w-12 h-12 bg-gold-light/20 rounded-lg flex items-center justify-center mx-auto mb-4">
                <Sparkles className="w-6 h-6 text-gold" />
              </div>
              <h3 className="text-primary font-semibold mb-2">Personalização</h3>
              <p className="text-muted-foreground text-sm">Deixe sua marca em cada peça</p>
            </div>
          </div>
          ...
          {/* Trust text */}
          <p className="text-muted-foreground/70 text-sm mt-6 animate-fade-up" style={{ animationDelay: '0.5s' }}>
